...
exports.default = _default;
        var $924d7f = exports.default || module.exports;
      
      if (typeof $924d7f === 'function') {
        $924d7f = $924d7f.options;
      }
    
        /* template */
        Object.assign($924d7f, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$924d7f', $924d7f);
          } else {
            api.reload('$924d7f', $924d7f);
          }
        }
